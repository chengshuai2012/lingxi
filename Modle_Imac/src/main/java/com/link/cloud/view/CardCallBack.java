...
public class CardCallBack extends ItemTouchHelper.SimpleCallback {
    private List<RetrunLessons.DataBean.LessonInfoBean.CardInfoBean> mDatas;
    private CardAdapter adapter;
    private RecyclerView mRv;

    public CardCallBack(List<RetrunLessons.DataBean.LessonInfoBean.CardInfoBean> mDatas, CardAdapter adapter, RecyclerView mRv) {
        super(0,
    ...
    public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
        ...
        RetrunLessons.DataBean.LessonInfoBean.CardInfoBean remove = mDatas.remove(viewHolder.getLayoutPosition());
        mDatas.add(0, remove);

...
public class SwipeCardCallBack extends ItemTouchHelper.SimpleCallback {
    private List<RetrunLessons.DataBean.LessonInfoBean> mDatas;
    private UniversalAdapter adapter;
    private RecyclerView mRv;

    public SwipeCardCallBack(List<RetrunLessons.DataBean.LessonInfoBean> mDatas, UniversalAdapter adapter, RecyclerView mRv) {
        super(0,
    ...
    public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
        ...
        RetrunLessons.DataBean.LessonInfoBean remove = mDatas.remove(viewHolder.getLayoutPosition());
        mDatas.add(0, remove);
